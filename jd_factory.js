...
const inviteCodes = [
  "T0205KkcFmN7ozyEWmKu9ohuCjVWnYaS5kRrbA",
...
function readShareCode() {
  console.log(`开始`)
  return new Promise(async resolve => {
    $.get({ url: `https://raw.githubusercontent.com/indextank/myjd3/master/backUp/total/jd_factory.json`, timeout: 10000 }, (err, resp, data) => {
      try {
        if (err) {
          console.log(`${JSON.stringify(err)}`)
          console.log(`${$.name} API请求失败，请检查网路重试`)
